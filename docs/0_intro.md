# Welcome to GeospaceLAB-Swarm 

This documentation is a guidance for accessing and visulizing ESA's Swarm mission data products using the Python package GeospaceLAB. The documentation is a part of the project "Extension of GeospaceLAB software package to support Swarm mission", supported by [Swarm-DISC](https://swarmdisc.org/#).
